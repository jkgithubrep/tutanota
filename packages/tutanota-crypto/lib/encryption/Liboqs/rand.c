...
/**
 * Load random bytes. This function simply returns the remaining number of bytes if amount is 0.
 *
 ...
 * @return       remaining number of bytes in the entropy pool
 */
...
/**
 * exit override - lock up in an infinite loop instead
 */
